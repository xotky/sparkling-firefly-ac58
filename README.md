...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/fp
```

A live public deployment of this template is available at [https://fp.templates.workers.dev](https://fp.templates.workers.dev)
